...
const Card = () => {
  return (
    <CardContainer>
      ...
      <Content>
        <UserInfo>
          <UserPicture src="https://avatars.githubusercontent.com/u/106930665?v=4"/>
         <div>
          <h4>Leticia Barros</h4>
          <p>Há 3 minutos</p>
        </div> 
        </UserInfo>
        <PostInfo>
          <h4>Projeto para curso de HTML, CSS e React.js </h4>
          <p>Projeto feito no curso de html e css no bootcamp da dio do Global avanade...<strong>Saiba Mais</strong></p>
        </PostInfo>
        <HasInfo>
          <h4>#HTML #CSS #Javascript #React.js #Orange Tech</h4>
          <p>
            <FiThumbsUp />89
          </p>
        </HasInfo>
